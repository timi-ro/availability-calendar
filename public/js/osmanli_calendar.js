...
CURRENT_DATE: new Date('2025', '08', '01'),
SELECT_DATE: new Date('2025', '08', '01'),
MIN_DATE: 'OFF',
MAX_DATE: 'OFF',
...
// Show Registration Data on Calendar
document.addEventListener('DOMContentLoaded', function() {
    var registeredDays = $('.js-reserved-days').data('reserved');

    jQuery.each(registeredDays, function(index, item) {
        var startDate = item.startDate.split('-')[2];
        var endDate   = item.endDate.split('-')[2];
        var fullName  = item.fullName;

        $('td[data-value]').each(function(i){
            var day = i + 1
    ...
    var remainder = $("td[data-value]:not(.disabled)").length;
